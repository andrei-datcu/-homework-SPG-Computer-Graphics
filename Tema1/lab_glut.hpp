...
namespace lab{ namespace glut{
		...
		//----------------------------------------------------------------------------------------
		//variabile statice
		extern WindowInfo _window_information;					//aici sunt tinute informatii despre fereastra
		extern FramebufferInfo _framebuffer_information;		//aici sunt tinute informatii despre framebuffer
		extern ContextInfo _context_information;				//aici sunt tinute informatii despre context
		extern bool _initialized;							//e initializat glut?
		extern WindowListener* _listener;					//cine asculta la glut pentru evenimente? hint: clasa in care (probabil) lucrati :)
