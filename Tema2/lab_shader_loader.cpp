...
#include <vector>
	...
	unsigned int lab::loadShader(const std::string &vertex_shader_file, const std::string &fragment_shader_file){
	...
	//returneaza id-ul programului shader OpenGL
	unsigned int lab::loadShader(const std::string &vertex_shader_file, const std::string &geometry_shader_file, const std::string &fragment_shader_file){
    ...
    unsigned int lab::loadShader(const std::string &compute_shader_file)
    {
        std::vector<unsigned int> shaders;
	...
	unsigned int lab::_createShader(const std::string &shader_file, GLenum shader_type){
	...
	unsigned int lab::_createProgram(const std::vector<unsigned int> &shader_objects){
